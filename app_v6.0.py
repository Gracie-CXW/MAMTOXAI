...
inputs = [
    ['question 1',[
        """ Determine the exposure type (ORAL, DERMAL, or INHALATION) for the toxicology study, then classify the exposure method based on these rules:\n
            ...
            - ORAL: gavage  \n
            - Null\n
            IMPORTANT: Ensure the last line of your output is the answer in the format specified above.\n
""",[]
    ]],
    ['question 2',[
    ...
    ['question 3',[
        ...
        - SOLVENT : no info\n
        IMPORTANT: Ensure the last line of your output is the answer in the format specified above.\n
        """,[['or','similar','solvent','vehicle','dissolve','prepared']]
    ]]
]
...
for idx_s, study in enumerate(all_studies):
    ...
    run_store_name = f"run_{str(idx_s+1)}_v6.0_phi4_ollama.txt"
    response_store_name = f"run_{str(idx_s+1)}_v6.0_phi4_ollama_response_only.txt"
